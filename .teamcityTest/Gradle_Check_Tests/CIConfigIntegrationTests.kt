...
class CIConfigIntegrationTests {
    ...
    fun onlyReadyForNightlyTriggerHasUpdateBranchStatus() {
        ...
        assertEquals(":distribution-core:base-services:createBuildReceipt updateBranchStatus -PgithubToken=%github.bot-teamcity.token%", triggerNameToTasks[readyForNightlyId])
