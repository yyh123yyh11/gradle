...
public abstract class DefaultSwiftComponent<T extends SwiftBinary> extends DefaultNativeComponent implements SwiftComponent, ComponentWithNames {
    ...
    public DefaultSwiftComponent(String name, ConfigurationContainer configurations, ObjectFactory objectFactory) {
        this(name, SwiftBinary.class, configurations, objectFactory);
    }

    public DefaultSwiftComponent(String name, Class<? extends SwiftBinary> binaryType, ConfigurationContainer configurations, ObjectFactory objectFactory) {
